...
const Donate = () => {
  ...
  const sponsors = [
    ...
    },
    {
      ...
      name: "Knovva Academy",
      description:
        "Knovva Academy Foundation, a global leader in educational empowerment and mentorship generously sponsored Numberosity Academy, advancing our shared mission to eliminate educational inequality and inspire the next generation of STEM leaders.",
