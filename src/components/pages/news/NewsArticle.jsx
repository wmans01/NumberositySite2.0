...
Let's give a huge round of applause to every single team for their accomplishments, and for lifting each other up every step of the way. All roads now lead to Dallas, May 2025—and we couldn't be more excited. 🎉🚀`,
      gallery: [
        {
          type: "image",
          url: "/news/clean-sweep-1.jpg",
          caption: "8889X Build award",
        },
        {
          type: "image",
          url: "/news/clean-sweep-2.jpg",
          caption: "8889A at the skills field",
        },
        {
          type: "image",
          url: "/news/clean-sweep-3.jpg",
...
In the qualification rounds, 8889C ranked #24 with 6 wins and 4 losses. They were fortunate to be picked by 13697H Stakehouse, earning a spot in the elimination rounds. Though 8889C fell short in the first round, this experience was a valuable stepping stone, setting the foundation for their growth and future success.`,
      gallery: [
        {
          type: "image",
          url: "/news/gateway-to-west-1.jpg",
          caption: "8889C at the competition field",
        },
        {
          type: "image",
          url: "/news/gateway-to-west-2.jpg",
          caption: "8889C working on their robot",
        },
        {
          type: "image",
          url: "/news/gateway-to-west-3.jpg",
          caption: "8889C getting interviewed",
        },
        {
          type: "image",
          url: "/news/gateway-to-west-4.jpg",
          caption: "8889C at the airport",
        },
        {
          type: "image",
          url: "/news/gateway-to-west-5.jpg",
          caption: "Logan coding on the practice field",
        },
        {
          type: "image",
          url: "/news/gateway-to-west-6.jpg",
...
It was a day full of teamwork, high-level performance, and unforgettable moments. We're proud of our teams for showing up strong and making the most of every opportunity—proving once again that it's not about how many events you attend, but how you show up when it matters.`,
      gallery: [
        {
          type: "image",
          url: "/news/killingly-robotics-1.jpg",
          caption: "Skills Champion",
        },
        {
          type: "image",
          url: "/news/killingly-robotics-2.jpg",
          caption: "8889A and their alliance partner 4478B Blizzard",
        },
        {
          type: "image",
          url: "/news/killingly-robotics-3.jpg",
...
We're incredibly proud of the progress so far and can't wait to see how RoboBridge continues to grow and evolve in the months ahead!`,
      gallery: [
        {
          type: "image",
          url: "/news/robobridge4-1.jpg",
          caption: "Jeremy",
        },
        {
          type: "image",
          url: "/news/robobridge4-2.jpg",
          caption: "The field",
        },
        {
          type: "image",
          url: "/news/robobridge4-3.jpg",
          caption: "Building a robot",
        },
        {
          type: "image",
          url: "/news/robobridge4-4.jpg",
          caption: "Luke",
        },
        {
          type: "image",
          url: "/news/robobridge4-5.jpg",
...
Here's to the incredible achievements of our teams—and the exciting journey ahead! 🚀🤖🎉`,
      gallery: [
        {
          type: "image",
          url: "/news/teams-face-off-1.jpg",
          caption: "8889B and 8889S",
        },
        {
          type: "image",
          url: "/news/teams-face-off-2.jpg",
...
We look forward to many more sessions of connection, discovery, and heart. Here's to building more than just robots—here's to building joy, confidence, and community. ❤️🎁`,
      gallery: [
        {
          type: "image",
          url: "/news/robobridge-christmas-1.png",
          caption: "Cluster 1",
        },
        {
          type: "image",
          url: "/news/robobridge-christmas-2.png",
          caption: "Cluster 2",
        },
      ],
    },
...
Keep building, keep learning, and keep having fun! We're just getting started!`,
      gallery: [
        {
          type: "image",
          url: "/news/regional-nationals-1.jpg",
          caption: "8889C getting inspected",
        },
        {
          type: "image",
          url: "/news/regional-nationals-2.jpg",
          caption: "8889C on the queueing table",
        },
        {
          type: "image",
          url: "/news/regional-nationals-3.jpg",
          caption: "8889C at the practice field",
        },
        {
          type: "image",
          url: "/news/regional-nationals-4.jpg",
          caption: "8889B at the pits",
        },
        {
          type: "image",
          url: "/news/regional-nationals-5.jpg",
          caption: "8889B winning design award",
        },
        {
          type: "image",
          url: "/news/regional-nationals-6.jpg",
          caption: "8889A's robot at the WPI venue",
        },
        {
          type: "image",
          url: "/news/regional-nationals-7.jpg",
          caption: "8889A at the practice field",
        },
        {
          type: "image",
          url: "/news/regional-nationals-8.jpg",
...
Congratulations to all our team members for their remarkable achievements! With this momentum, we are excited to continue working toward even greater milestones as we set our sights on the 2025 World Championship.`,
      gallery: [
        ...
        {
          type: "image",
          url: "/news/north-andover-2.jpg",
          caption: "8889A Excellence Award",
        },
        {
          type: "image",
          url: "/news/north-andover-3.jpg",
...
It was an unforgettable experience, and we're excited to see where this journey will take us next!`,
      gallery: [
        {
          type: "image",
          url: "/news/mass-robotics-block-1.jpg",
          caption: "8889A with their robot in the parade",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-2.jpg",
          caption: "Numberosity's booth",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-3.jpg",
          caption: "People trying out the robots",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-4.jpg",
          caption: "Spot the robot dog",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-5.jpg",
          caption: "FRC Robots",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-6.jpg",
          caption: "Representing VEX",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-7.jpg",
          caption: "Passserbys checking out the robots",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-8.jpg",
          caption: "8889B",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-9.jpg",
          caption: "The event",
        },
        {
          type: "image",
          url: "/news/mass-robotics-block-10.jpg",
...
A big thanks to all our alliances, volunteers, event staff, and everyone else involved in making this event such an incredible experience. We look forward to the exciting challenges ahead!`,
      gallery: [
        ...
        {
          type: "image",
          url: "/news/lobstah-bowl-1.jpg",
          caption: "8889A Excellence Award",
        },
        {
          type: "image",
          url: "/news/lobstah-bowl-2.jpg",
          caption: "8889A with their alliance partner, 8829C Cat-alyst",
        },
        {
          type: "image",
          url: "/news/lobstah-bowl-3.jpg",
          caption: "8889A Skills Champion",
        },
        {
          type: "image",
          url: "/news/lobstah-bowl-4.jpg",
          caption: "Match fields",
        },
        {
          type: "image",
          url: "/news/lobstah-bowl-5.jpg",
...
Stay tuned for more updates and opportunities to get involved!`,
      gallery: [
        {
          type: "image",
          url: "/news/team-expansion-1.jpg",
          caption: "Image Cluster 1",
        },
        {
          type: "image",
          url: "/news/team-expansion-2.jpg",
          caption: "Image Cluster 2",
        },
        {
          type: "image",
          url: "/news/team-expansion-3.jpg",
          caption: "Image Cluster 3",
        },
        {
          type: "image",
          url: "/news/team-expansion-4.jpg",
...
From educational demonstrations to inspiring conversations, the event was filled with fun, learning, and meaningful connections. We’re grateful for the opportunity to be part of such a vibrant community event and look forward to continuing to inspire and innovate through robotics.`,
      gallery: [
        ...
        {
          type: "image",
          url: "/news/lexington-discovery-day-1.jpg",
          caption: "Peter helping a child with the controls",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-2.jpg",
          caption: "Jason helping a child with the controls",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-3.jpg",
          caption: "The booth",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-4.jpg",
          caption: "People coming to look",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-5.jpg",
          caption: "Booth setup",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-6.jpg",
          caption: "Charles and Jason",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-7.jpg",
          caption: "Peter",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-8.jpg",
          caption: "Ryan",
        },
        {
          type: "image",
          url: "/news/lexington-discovery-day-9.jpg",
          caption: "Jeremy",
        },
      ],
    },
